<div>
    <header class="tm-header" id="tm-header">
        <div class="tm-header-wrapper">
            ...
            <div class="tm-mb-65">
                <a rel="nofollow" href="https://fb.com/{{ $contact->facebook ?? '' }}" class="tm-social-link">
                    <i class="fab fa-facebook tm-social-icon"></i>
                </a>
                <a href="https://twitter.com/{{ $contact->twitter ?? '' }}" class="tm-social-link">
                    <i class="fab fa-twitter tm-social-icon"></i>
                </a>
                <a href="https://instagram.com/{{ $contact->instagram ?? '' }}" class="tm-social-link">
                    <i class="fab fa-instagram tm-social-icon"></i>
                </a>
                <a href="https://linkedin.com/{{ $contact->linkedin ?? '' }}" class="tm-social-link">
